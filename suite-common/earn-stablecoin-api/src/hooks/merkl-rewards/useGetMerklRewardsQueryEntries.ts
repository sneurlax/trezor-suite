...
type UseGetMerklRewardsQueryEntriesOptions = {
    isDebugMode?: boolean;
...
export function getMerklRewardsQueryEntriesForAccounts(
    accounts: Account[],
    { isDebugMode, skipEmptyAccountCheck = false }: UseGetMerklRewardsQueryEntriesOptions = {},
) {
...
export function useGetMerklRewardsQueryEntries(
    accounts: Account[],
    { isDebugMode, skipEmptyAccountCheck }: UseGetMerklRewardsQueryEntriesOptions = {},
) {
    return useMemo(
        () =>
