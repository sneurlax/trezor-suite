...
// Re-export for back-compat — source of truth lives in wallet-core so the
// scoped run wrapper can import it without crossing the connect-init -> wallet-core
// dependency edge.
export { defaultTrezorUIEventHandlerThunk };
